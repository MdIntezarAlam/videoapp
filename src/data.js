...
export const categories = [
    { id: 1, name: "Game", iconSrc: <IoGameController fontSize={30} /> },
    { id: 2, name: "Funnay", iconSrc: <FaSmileWink fontSize={30} /> },
    ...
    { id: 6, name: "Mugic", iconSrc: <IoMdMusicalNote fontSize={30} /> },
